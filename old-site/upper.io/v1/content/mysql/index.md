...
To use this adapter, import `upper.io/db.v1` and the `upper.io/db.v1/mysql` packages.
...
import (
  ...
  "upper.io/db.v1/mysql"   // Imports the mysql adapter.
)
